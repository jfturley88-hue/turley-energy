...
same rate book, so every figure in the pack traces to one run of the software.

An editable Word file of the prose in documents 01 and 05 is built into
`pack/PlanitBER_Editable_Text/`, block by block, for marking up and returning.
